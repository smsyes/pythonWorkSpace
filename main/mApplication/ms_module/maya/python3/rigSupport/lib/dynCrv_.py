...
pm.addAttr(sel[-1], ln="curlStartPostion",at='double',min=0,max=1,dv=0,k=1)
pm.addAttr(sel[-1], ln="curlEndPosition",at='double',min=0,max=1,dv=1,k=1)
pm.addAttr(sel[-1], ln="curlInterpolation",at='long',min=0,max=2,dv=1,k=1)
pm.addAttr(sel[-1], ln="curlStart",at='double',dv=0,k=1)
pm.addAttr(sel[-1], ln="curlEnd",at='double',dv=0,k=1)
