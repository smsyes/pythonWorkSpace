...
'''
version 3.0
added support for all maya unit types
...
def motionPath( itemList, curvePath, upObject, frontAxis, invertFront, upAxis, invertUp, cycleAttributeName ):
	...
	for i in range( 0, len( itemList ) ):
		...
		ma.setDrivenKeyframe( driven, cd=upObject + '.' + attributeList[0], dv= ( i * offset ) + 1, v=sceneUnitMultiplier, itt = 'linear', ott = 'linear' )
